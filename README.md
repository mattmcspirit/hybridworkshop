...
Version
-----------
This guide has been tested and validated with the **September 2021 release** of AKS on Azure Stack HCI, and **Azure Stack HCI 20H2** with the latest updates installed.
